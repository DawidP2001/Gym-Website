...
const BookTourSection: React.FC<BookTourSectionProps> = ({ className }) => {
    return (
        ...
        >
            <div className="bg-yellow-400/35 backdrop-blur-xs p-8 h-100 w-full flex flex-col items-center justify-center text-center gap-4">
                <h2 className="text-4xl text-gray-200 font-semibold mb-6 text-shadow-lg">Book a Tour</h2>
